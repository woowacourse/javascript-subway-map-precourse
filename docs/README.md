...
- 지하철 노선도 애플리케이션입니다.
- 수도권 지하철의 역과 노선을 추가할 수 있으며, 원하는 대로 구간 설정이 가능합니다.
- 추가된 노선을 map 형식으로 확인할 수 있습니다.

## 🚀 모듈 목록

- SubwayMap.js (지하철 노선도 모듈)
- RoleInterface.js (기능 내 공통 처리 이벤트를 모아둔 클래스)
- Role.js (기능 클래스)
  - StationManager.js
  - LineManager.js
  - SectionManager.js
  - MapPrintManager.js
- Validator.js (유효성 검사 클래스)
  - StationValidator.js
  - LineValidator.js
  - SectionValidator.js

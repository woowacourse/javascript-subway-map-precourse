...
- [ ] 구간 관리 기능 버튼
- [ ] 지하철 노선도 출력 버튼
- [ ] 각 버튼이 눌리면 해당 버튼과 관련된 기능 보여주기
- [ ] 다른 버튼이 눌리면 현재 기능 숨기고 새롭게 눌린 기능 보여주기

### 지하철 역 관련 기능
- [ ] 지하철 역 등록하기
- [ ] 지하철 역 삭제하기
  - 삭제 시 한번 `alert`로 한번 더 물어보기 
- [ ] 지하철 역 이름 검사하기
  - 중복이 있으면 안됨
  - 2 글자 이상
  - 예외시 `alert`
...
- [ ] 구간을 수정할 노선 선택
  - #호선 버튼
- [ ] 역을 `select`로 선택해서 순서 (인덱스)를 입력받으면 테이블에 추가하기
  - 예외: 0 이상의 정수만 입력 가능함
